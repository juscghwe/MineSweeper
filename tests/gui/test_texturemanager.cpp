...
class TextureManagerTest : public ::testing::TestWithParam<KTextures::CellState>
{
  protected:
...
{
    KTextures::CellState state = GetParam();
...
INSTANTIATE_TEST_SUITE_P(TextureStates, TextureManagerTest,
                         ::testing::Values(KTextures::CellState::Flagged, KTextures::CellState::Mine,
                                           KTextures::CellState::Unknown, KTextures::CellState::Empty));
...
TEST_P(TextureManagerAdjecentTest, LoadsTextureForAdjecent)
{
    ...
    EXPECT_NO_THROW(textureManager.getTexture(KTextures::CellState::Adjecent,
                                              adjecentMines));  // Ensure no exception is thrown
    EXPECT_TRUE(textureManager.getTexture(KTextures::CellState::Adjecent, adjecentMines).getSize().x >
...
{
    EXPECT_THROW(textureManager.getTexture(static_cast<KTextures::CellState>(999)),
...
{
    EXPECT_THROW(textureManager.getTexture(KTextures::CellState::Adjecent, 99),
